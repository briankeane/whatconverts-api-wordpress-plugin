...
class WCM_Settings {
    ...
    public static function render_page(): void {
        ...
        <div class="wrap">
            ...
            <table class="widefat" style="max-width:500px">
                ...
                <tr><td><code>[wc_sales_value]</code></td><td>Total sales value (closed revenue)</td></tr>
                <tr><td><code>[wc_quote_value]</code></td><td>Total quote value (potential revenue)</td></tr>
    ...
    private static function render_metrics_preview(): void {
        ...
        <table class="widefat" style="max-width:300px">
            ...
            <tr><td>Sales Value</td><td>$<?php echo number_format($metrics['sales_value']); ?></td></tr>
            <tr><td>Quote Value</td><td>$<?php echo number_format($metrics['quote_value']); ?></td></tr>
